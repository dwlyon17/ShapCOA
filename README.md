...
Initial release, version 0.2.0, August 27, 2026.
...
* Built-in provisions for key driver regressions, including options for missing data,
...
* Exact computations via hypergeometric probabilities for both standard TURF and many variants of TURF,
* Functions to perform TURF proper searches, and many variants (i.e., searching for best combinations, not just for Shapley Values).
